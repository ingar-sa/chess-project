...
with open("pane_tags.txt", "w") as file:
...
with open("sprite_tags.txt", "w") as file:
    for row in range(0, 8):
        for col in range(0, 8):
            file.write('<ImageView fx:id="sprite{}{}" id="{}{}" fitHeight="65.0" fitWidth="65.0" pickOnBounds="true" preserveRatio="true" GridPane.columnIndex="{}" GridPane.rowIndex="{}">\n<GridPane.margin>\n<Insets left="17.5" />\n</GridPane.margin>\n</ImageView>\n'.format(row, col, row, col, col, 7-row))
